    ...
    {/* <div className="relative h-auto mb-0 bg-cover bg-center bg-no-repeat" style={{backgroundImage: 'url(/images/background.jpg)'}}> */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto h-screen  flex items-center justify-between bg-primary">
       ...
       <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-32 left-8 star-rotate">
          <svg width="110" height="110" viewBox="0 0 24 24" className="star-outline">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
          </svg>
        </div>
        <div className="absolute bottom-16 right-8 star-rotate-reverse">
          <svg width="130" height="130" viewBox="0 0 24 24" className="star-outline">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
          </svg>
        </div>
      </div>
        ...
        <div className="absolute top-4 left-4 w-8 h-5 bg-gradient-to-r from-pink-400 to-pink-600 rounded-full opacity-80 animate-bounce shadow-xl transform rotate-12"></div>
        ...
        <div className="absolute top-56 right-1/3 w-6 h-4 bg-gradient-to-r from-indigo-400 to-indigo-600 rounded-full opacity-65 animate-bounce shadow-lg transform -rotate-30" style={{animationDelay: '3.5s'}}></div>
        ...
        <div className="absolute top-80 left-2/3 w-5 h-3 bg-gradient-to-r from-cyan-400 to-cyan-600 rounded-full opacity-60 animate-bounce shadow-lg transform rotate-15" style={{animationDelay: '5s'}}></div>
        ...
        <div className="absolute top-128 left-1/5 w-6 h-4 bg-gradient-to-r from-sky-400 to-sky-600 rounded-full opacity-60 animate-bounce shadow-lg transform rotate-20" style={{animationDelay: '8s'}}></div>
        <div className="absolute top-136 right-1/5 w-5 h-3 bg-gradient-to-r from-orange-300 to-orange-500 rounded-full opacity-70 animate-bounce shadow-lg transform -rotate-20" style={{animationDelay: '8.5s'}}></div>
         ...
         <div className="flex-1 flex justify-center items-center">
           <div className="relative group">
             ...
             <Image 
               ...
               width={600}
               height={600}
               className="absolute top-[-250px] left-1/2 transform -translate-x-1/2 w-[320px] h-[320px] object-contain z-10"
             />
             ...
             <Image 
               ...
               width={400}
               height={400}
               className="w-[400px] h-[400px] mt-10 object-contain"
             />
             ...
             <div className="absolute top-4/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
               <div className={`${coiny.className} leading-none text-white
                  ...
                  <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${
                    ...
                    <div className="text-[150px]">{(appleRate.new_user).toFixed(0)}</div>
                    <div>
                      <div className="text-[60px]">{(appleRate.new_user).toFixed(1).substring(2)}</div>
                  ...
                  <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${
                    ...
                    <div className="text-[150px]">{(appleRate.repeat_user).toFixed(0)}</div>
                    <div>
                      <div className="text-[60px]">{(appleRate.repeat_user).toFixed(1).substring(2)}</div>
                      <div className="text-[40px]">%</div>
                    </div>
                  </div>
               </div>
               ...
               {/* Badge */}
               <div className="bg-white text-center text-xl font-bold  rounded-full px-4 py-1 flex items-center relative mt-18">
                 <div className="w-1/3">
                   <Image src="/images/brands/icon_apple.png" alt="Apple" width={1000} height={1000} className="w-12 h-12 object-contain rounded-full" />
                 </div>
                 
                 {/* New User Badge */}
                 <div className={`w-2/3 text-left pl-2 transition-opacity text-[#35cca4] duration-500 ${
                   !showRepeatRate ? 'opacity-100' : 'opacity-0'
                 }`}>
                   初回限定
                 </div>
                 ...
                 {/* Repeat User Badge */}
                 <div className={`absolute right-4 transition-opacity text-primary duration-500 ${
                   showRepeatRate ? 'opacity-100' : 'opacity-0'
                 }`}>
                   リピート
                 </div>
         ...
         <div className="flex-1 flex justify-center items-center">
           <div className="text-center">
            <Image 
                src="/images/hero-point.png" 
                alt="Hero Image" 
                width={700}
                height={700}
                className="relative w-[700px] h-[700px] ml-[250px] object-contain"
              />
           </div>
         </div>        
       </div>
